    ...
    return ( 
        <ContenedorContacto>
            ...
            <form action='' onSubmit={actualizarContacto}>
                <Input type='text' name='nombre'  value={nuevoNombre}  onChange={(e)=> cambiarNuevoNombre(e.target.value)}   placeholder='Nombre' />
                <Input type='text' name='correo'  value={nuevoCorreo}  onChange={(e)=> cambiarNuevoCorreo(e.target.value)}   placeholder='Correo' />
